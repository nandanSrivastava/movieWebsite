...
class MockDatabase implements DatabaseClient {
  ...
  private seed() {
    ...
    this.movies.set(m2, {
      id: m2,
      title: 'Wicked',
      synopsis: 'Elphaba, an untamed, misunderstood young woman born with unusual green skin, and Glinda, a popular, gilded young woman, meet as students at Shiz University in the Land of Oz and forge an unlikely but profound friendship.',
    ...
    this.movies.set(m4, {
      ...
      synopsis: 'Jake Sully lives with his newfound family formed on the extrasolar moon Pandora. Once a familiar threat returns, Jake must work with Neytiri and the army of the Na\'vi race to protect their planet.',
      genre: 'Action, Sci-Fi',
      language: 'English (3D)',
    ...
    this.movies.set(m6, {
      ...
      synopsis: 'A listless Wade Wilson toils away in civilian life. His days as the morally flexible mercenary, Deadpool, behind him. When his homeworld faces an existential threat, Wade must reluctantly suit-up again.',
      genre: 'Action, Comedy',
      language: 'English',
