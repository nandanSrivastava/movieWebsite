...
-- Movies
INSERT INTO public.movies (id, title, synopsis, genre, language, duration_minutes, certification, poster_url, trailer_url, is_active) VALUES
  ('d798a3b8-6c84-4828-98e3-50ebbc2a1d21', 'Gladiator II',      'Years after witnessing the death of the revered hero Maximus, Lucius is forced into the Colosseum by tyrannical Emperors.', 'Action, Drama',       'English (Subtitles)', 148, 'UA', 'https://images.unsplash.com/photo-1536440136628-849c177e76a1?q=80&w=400&auto=format&fit=crop', 'https://www.youtube.com/embed/g6j3k4rK7u4', TRUE),
  ('e0e56e07-6bcf-40a2-8b8b-d784fa734e56', 'Wicked',            'Elphaba and Glinda meet at Shiz University in Oz and forge an unlikely friendship.', 'Fantasy, Musical',    'English',             160, 'U',  'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?q=80&w=400&auto=format&fit=crop', 'https://www.youtube.com/embed/6COmYeLsz4c', TRUE),
  ('9d863f69-d9fe-45db-b962-73a71bbf5327', 'Dune: Part Two',    'Paul Atreides unites with Chani and the Fremen seeking revenge against the conspirators who destroyed his family.', 'Sci-Fi, Adventure',   'English (Subtitles)', 166, 'UA', 'https://images.unsplash.com/photo-1509198397868-475647b2a1e5?q=80&w=400&auto=format&fit=crop', 'https://www.youtube.com/embed/Way9Dexny3w', TRUE),
  ('a1b2c3d4-e5f6-7890-1234-56789abcdef0', 'Avatar: The Way of Water', 'Jake Sully lives with his newfound family on Pandora. A familiar threat forces him to fight back.', 'Action, Sci-Fi',      'English (3D)',        192, 'UA', 'https://images.unsplash.com/photo-1626814026160-2237a95fc5a0?q=80&w=400&auto=format&fit=crop', 'https://www.youtube.com/embed/d9MyW72ELq0', TRUE),
  ('b2c3d4e5-f6a7-8901-2345-6789abcdef01', 'Oppenheimer',       'The story of J. Robert Oppenheimer and his role in the development of the atomic bomb.', 'Biography, Drama',    'English',             180, 'A',  'https://images.unsplash.com/photo-1533518463841-d62e1fc91373?q=80&w=400&auto=format&fit=crop', 'https://www.youtube.com/embed/uYPbbksJxIg', TRUE),
  ('c3d4e5f6-a7b8-9012-3456-789abcdef012', 'Deadpool & Wolverine', 'Wade Wilson must reluctantly suit up again when his homeworld faces an existential threat.', 'Action, Comedy',      'English',             127, 'A',  'https://images.unsplash.com/photo-1608889175250-c3b0c1667d3a?q=80&w=400&auto=format&fit=crop', 'https://www.youtube.com/embed/73_1biulkYk', TRUE)
ON CONFLICT (id) DO NOTHING;
